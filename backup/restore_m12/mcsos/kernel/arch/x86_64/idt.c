...
void x86_64_idt_init(void) {
    ...
    // Invariant Verification (Memastikan ukuran struct valid)
    ...
    // Eksekusi instruksi assembly 'lidt'
    lidt(&idtr);
